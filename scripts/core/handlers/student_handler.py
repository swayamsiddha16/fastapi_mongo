from scripts.db.mongo import add_student,view_students,update_student,delete_student,aggregated_student_data,Student,view_student,view_studentbykey
...
class Studenthandler:    
    ...
    def get_student_bykey(self,key:str,val):
        data = view_studentbykey(key,val)
        if data:
            return{"status":"success","response":data,"message":"data fetched successfully"}
        else:
            return{"status":"error"}
       
    def get_student_byId(self,id : int):
